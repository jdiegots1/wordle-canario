...
const handleStartGameClick = () => {
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div className="bg-white rounded-lg shadow-lg p-6 text-center max-w-lg w-full sm:max-w-md sm:p-4">
      ...
      <p className="text-xs sm:text-sm font-medium mb-4">
        El juego está en constante mantenimiento... <strong>puedes jugar sin publicidad</strong>.
      </p>
      <p className="text-xs sm:text-sm font-medium mb-4">
        Si te gusta el juego, ¡puedes apoyarme donando en <a href="https://www.paypal.me/wordlecanario" target="_blank" className="underline text-blue-500">www.paypal.me/wordlecanario</a>!
      </p>
