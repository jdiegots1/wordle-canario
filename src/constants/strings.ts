...
export const WIN_MESSAGES = ['Ossss', 'Chacho, me cambaste la peluca, correctísimo, la palabra era '+${solution}, 'De locos', 'Estás hecho un puntal', 'Creeeema', 'Chiquito jeito tienes pa esto, hermano 👌']
