...
export const WORD_NOT_FOUND_MESSAGE = ['Venga, inténtalo con otra palabra que esa no existe', 'A otro, que sea más primo, vale, pero a mí no. Escribe una palabra que exista, hazme el favor.', 'Métele mano a eso, que esa palabra no existe', 'Venga, sí. Esa palabra 1, Las Palmas 2. Pon una palabra que exista, hermano', 'Va, va, inténtalo con otra palabra', ]
