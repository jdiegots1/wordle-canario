...
export const WIN_MESSAGES = ['De locos <br/>El naife es un cuchillo o navaja grande. Suele emplearse en Gran Canaria y Tenerife.', 'Estás hecho un puntal', 'Creeeema', 'Chiquito jeito tienes pa esto, hermano 👌', {"src":"/pepe.jpg"}]
...
export const WORD_NOT_FOUND_MESSAGE = ['A otro, que sea más primo, vale, pero a mí no. Escribe una palabra que exista, hazme el favor.', 'Métele mano a eso, que esa palabra no existe', 'Venga, sí. Esa palabra 1, Las Palmas 2. Pon una palabra que exista, hermano']
export const CORRECT_WORD_MESSAGE = (solution: string) =>
  `El conejo te enriscó la perra: la palabra era ${solution}. El naife es un cuchillo o navaja grande. Suele emplearse en Gran Canaria y Tenerife.` 
