...
export const WIN_MESSAGES = ["pepe.jpg", 'Ossss', 'Chacho, me cambaste la peluca, correctísimo', 'De locos', 'Estás hecho un puntal', 'Creeeema', 'Chiquito jeito tienes pa esto, hermano 👌']
