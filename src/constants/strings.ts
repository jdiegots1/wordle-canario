...
export const WIN_MESSAGES = ['Lo mínimo que te mereces después de acertar es un anochecer en Las Canteras, un viajecito a La Palma para comer papas locas o ir a un buen guachinche en Tenerife. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren', 'Naa, me tienes enchochadísimo 😍. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren', 'Estás hecho un puntal. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren.', 'Creeeema. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren.', 'Chiquito jeito tienes pa esto, hermano 👌. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren', 'Lo mínimo que te mereces después de acertar es una buena verbena 🕺💃. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren']
...
export const CORRECT_WORD_MESSAGE = (solution: string) =>
  `El conejo te enriscó la perra: la palabra era ${solution}. Las taifas son las parejas que bailan nuestras canciones tradiciones en locales reducidos. "No perder alguien taifa" significa no dejar escapar el tren.`
